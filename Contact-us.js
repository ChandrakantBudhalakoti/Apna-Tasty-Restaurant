function validateForm() {
  ...
  var tempEmailProviders = ["tempmail.com", "emltmp.com", "spymail.one", "freeml.net", "zeroe.ml", "guerrillamail.com", "10minutemail.com"];
  ...
  if (isTempEmail) {
     document.getElementById("emailError").classList.remove("d-none");
     document.getElementById("emailError").innerHTML = "Temporary email addresses are not allowed.";
     return false;
  } else {
     document.getElementById("emailError").classList.add("d-none");
  }
